        ...
        if (decoded.isNotEmpty) {
          ...
          try {
            ...
            if (aqiRes.statusCode == 200) {
              ...
              if (aqiDecoded['current'] != null &&
                  aqiDecoded['current']['us_aqi'] != null) {
                          ...
                          Container(
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                hintText: isEn
                                    ? 'Search address, city, or province...'
                                    : 'Cari alamat, kota, atau provinsi...',
                                hintStyle: TextStyle(
                                  color: subTextColor,
                                  fontSize: 12,
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    isEn
                                        ? 'AQI Monitoring Stations (${filtered.length})'
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 12),
                      Expanded(
                        child: _buildPollutantMeter('O3', '$o3', o3 / 120),
                      ),
                      const SizedBox(width: 12),
                      Expanded(
                        child: Container(
